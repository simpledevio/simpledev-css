...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/simpledevio/simpledev-css@v0.2.0/dist/simpledev.css">
```
...
```html
<script src="https://cdn.jsdelivr.net/gh/simpledevio/simpledev-css@v0.2.0/dist/navbar.js" defer></script>
```
