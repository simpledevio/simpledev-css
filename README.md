...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/simpledevio/simpledev-css@v0.3.4/dist/simpledev.css">
```
...
```html
<script src="https://cdn.jsdelivr.net/gh/simpledevio/simpledev-css@v0.3.4/dist/navbar.js" defer></script>
```
